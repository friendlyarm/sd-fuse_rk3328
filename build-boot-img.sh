...
if [ $# -lt 2 ]; then
    ...
    echo "example:"
    echo "    tar xvzf NETDISK/rk3328/rootfs/rootfs-friendlycore-lite-noble-arm64-20190603.tgz"
    echo "    ./build-boot-img.sh friendlycore-lite-noble-arm64/boot friendlycore-lite-noble-arm64/boot.img"
    exit 1
fi
TOPPATH=$PWD
