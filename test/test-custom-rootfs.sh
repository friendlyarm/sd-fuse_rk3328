...
wget http://${HTTP_SERVER}/dvdfiles/RK3328/rootfs/rootfs-friendlycore-focal-arm64.tgz
...
(cd friendlycore-focal-arm64/rootfs/root/ && {
	wget http://${HTTP_SERVER}/dvdfiles/RK3328/images-for-eflasher/friendlycore-focal-arm64-images.tgz -O deleteme.tgz
});
