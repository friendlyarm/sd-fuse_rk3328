...
function usage() {
       echo "Usage: $0 <friendlycore-lite-focal-arm64|debian-bullseye-core-arm64|openmediavault-arm64|friendlywrt22|friendlywrt22-docker|friendlywrt21|friendlywrt21-docker>"
       echo "# example:"
