...
function usage() {
       echo "Usage: $0 <friendlywrt22,friendlywrt22-docker,friendlywrt21,friendlywrt21-docker,friendlycore-lite-focal-arm64,debian-bullseye-core-arm64,openmediavault-arm64> [img filename] [options]"
       echo "    examples:"
