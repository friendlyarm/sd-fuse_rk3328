...
*Note: Here we use ubuntu-noble-core system as an example*  
Clone this repository locally, then download and uncompress the [pre-built images](https://downloads.friendlyelec.com/os-images/rk3328/images), here you need to download the ubuntu-noble-core and eflasher [pre-built images](https://downloads.friendlyelec.com/os-images/rk3328/images):
```
git clone https://github.com/friendlyarm/sd-fuse_rk3328 -b kernel-6.1.y --single-branch sd-fuse_rk3328-kernel6.1
cd sd-fuse_rk3328-kernel6.1
wget https://downloads.friendlyelec.com/os-images/rk3328/images/ubuntu-noble-core-arm64-images.tgz
